...
| Dotfiles, generated bytecode and unsafe package members fail closed | publication and package-proof scripts | 7/7 source-scan and 10/10 package-member self-tests | Implemented |
