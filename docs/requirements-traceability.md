...
| DNS rows cannot carry impossible Line-crossing or elapsed-time evidence | story and classification schemas | story-intake and public-classification DNS timing regressions | Implemented |
...
| Dotfiles, generated bytecode and unsafe package members fail closed | publication and package-proof scripts | 11/11 source-scan and 11/11 package-member self-tests | Implemented |
| Locked clean verification | `pyproject.toml`, `uv.lock`, CI | 55 tests plus Ruff, strict MyPy, scanner self-tests, source scan, build and package proof | Implemented |
