...
| Dotfiles, generated bytecode and unsafe package members fail closed | publication and package-proof scripts | 7/7 source-scan and 11/11 package-member self-tests | Implemented |
| Locked clean verification | `pyproject.toml`, `uv.lock`, CI | 51 tests plus Ruff, strict MyPy, scanner self-tests, source scan, build and package proof | Implemented |
