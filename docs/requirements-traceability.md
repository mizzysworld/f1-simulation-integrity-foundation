...
| Dotfiles, generated bytecode and unsafe package members fail closed | publication and package-proof scripts | 7/7 source-scan and 6/6 package-member self-tests | Implemented |
