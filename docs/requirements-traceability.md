...
| Dotfiles, generated bytecode and unsafe package members fail closed | publication and package-proof scripts | 8/8 source-scan and 11/11 package-member self-tests | Implemented |
