...
The public suite contains exactly **55 collected tests**.
...
| `tests/unit/test_settlement.py` | 15 | threshold classification, DNS timing-evidence denial, DQ-inclusive `1..N` crossing and partial-known chronology, bounded penalties, DQ/DNS, forged-state rejection |
...
| **Total** | **55** | Full Phase 0B.2 behavioral gate |
